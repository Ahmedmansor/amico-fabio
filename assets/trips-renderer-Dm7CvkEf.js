        ...
        `).join("");e.innerHTML=t},renderRealCards:(e,t)=>{const s=e.filter(o=>String(o.featured||"").toUpperCase()==="TRUE");if(!s||s.length===0){r._renderEmptyState(t);return}const a=document.createDocumentFragment(),i=r._utils.getLang();s.forEach((o,l)=>{const n=r.createTripCard(o,i,l);n&&a.appendChild(n)}),t.appendChild(a),window.AOS&&window.AOS.refresh()},_renderEmptyState:e=>{const t=r._utils.getLang(),s=r._utils.getI18n(t),a=s&&s.global&&typeof s.global.no_exclusive_experiences=="string"?s.global.no_exclusive_experiences:"";e.innerHTML=`<div class="col-span-full text-center py-20">
            ...
            <article class="${u.join(" ")}" data-trip-id="${e.trip_id}" data-aos="fade-up" data-aos-delay="${x}">
                ...
                <div class="card-content">
                    ${i?`<div class="text-[10px] tracking-[0.22em] uppercase text-gold mb-1" data-i18n="global.premium_package">${I}</div>`:""}
