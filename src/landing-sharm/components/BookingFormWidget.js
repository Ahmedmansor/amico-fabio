...
const BookingFormWidget = {
  init: () => {
    ...
    host.innerHTML = `
      <section class="lsh-section lsh-booking">
        <div class="lsh-section-inner">
          <div class="lsh-section-header">
            <h2 class="lsh-section-title">Prenota Ora</h2>
            <p class="lsh-section-subtitle">Compila il modulo e ti rispondiamo subito su WhatsApp</p>
            <hr class="lsh-gold-divider" />
          </div>

          <div class="lsh-booking-card">
            <form class="lsh-form" id="lsh-booking-form" novalidate>
              <div class="lsh-form-group">
                <label class="lsh-form-label" for="lsh-name">Nome Completo</label>
                <input class="lsh-form-input" type="text" id="lsh-name"
                       placeholder="Il tuo nome..." autocomplete="name" required />
                <span class="lsh-form-error" id="lsh-name-error">Per favore inserisci il tuo nome.</span>
              </div>

              <div class="lsh-form-group">
                <label class="lsh-form-label" for="lsh-date">Data di Arrivo</label>
                <input class="lsh-form-input" type="date" id="lsh-date" required />
                <span class="lsh-form-error" id="lsh-date-error">Per favore seleziona una data.</span>
              </div>

              <div class="lsh-form-group">
                <label class="lsh-form-label" for="lsh-people">Numero di Persone</label>
                <input class="lsh-form-input" type="number" id="lsh-people"
                       min="1" max="30" value="2" placeholder="2" required />
                <span class="lsh-form-error" id="lsh-people-error">Inserisci un numero valido (1-30).</span>
              </div>

              <button class="lsh-form-submit" type="submit">
