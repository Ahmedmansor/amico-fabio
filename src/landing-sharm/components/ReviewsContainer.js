...
const ReviewsContainer = {
  init: () => {
    ...
    host.innerHTML = `
      <section class="lsh-section lsh-reviews-section">
        <div class="lsh-section-inner">
          <div class="lsh-section-header">
            <h2 class="lsh-section-title">Dicono di Noi</h2>
            <p class="lsh-section-subtitle">Le parole dei nostri ospiti su Facebook</p>
            <hr class="lsh-gold-divider" />
          </div>

          <div id="landing-reviews-container">
            <div class="lsh-reviews-slider">
              <div id="reviewsTrack" class="reviews-track" role="list" aria-label="Testimonianze"></div>
            </div>
          </div>

          <div class="reviews-footer" style="display: flex; justify-content: center; margin-top: 1.8rem;">
            <a class="reviews-facebook-btn" target="_blank" rel="noopener noreferrer"
              ...
              <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" style="width: 20px; height: 20px; fill: #1877F2;">
